...
do_osc() {
    ...
    print_osc_rgb 10 "96/86/84"
    print_osc_rgb 11 "12/12/13"
    print_osc_rgb 12 "96/86/84"
    print_osc_rgb 17 "af/9a/91"
    print_osc_rgb 19 "57/20/00"
}

do_linux() {
    print_linux 0 "#121213"
    print_linux 1 "#b93934"
    print_linux 2 "#90773e"
    print_linux 3 "#8085ef"
    print_linux 4 "#5e62b4"
    print_linux 5 "#a07c7b"
    print_linux 6 "#8eaea9"
    print_linux 7 "#968684"
    print_linux 8 "#665e6c"
