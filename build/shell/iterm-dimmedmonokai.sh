...
do_osc() {
    ...
    print_osc_rgb 10 "b8/bc/b9"
    print_osc_rgb 11 "1e/1e/1e"
    print_osc_rgb 12 "f8/3d/19"
    print_osc_rgb 17 "29/2c/31"
    print_osc_rgb 19 "b8/bc/b9"
}

do_linux() {
    print_linux 0 "#3a3c43"
    print_linux 1 "#be3e48"
    print_linux 2 "#869a3a"
    print_linux 3 "#c4a535"
    print_linux 4 "#4e76a1"
    print_linux 5 "#855b8d"
    print_linux 6 "#568ea3"
    print_linux 7 "#b8bcb9"
