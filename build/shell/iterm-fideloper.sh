...
do_osc() {
    ...
    print_osc4 3 "b7/aa/9a"
    print_osc4 4 "2e/78/c1"
    print_osc4 5 "c0/22/6e"
    print_osc4 6 "30/91/85"
    print_osc4 7 "e9/e2/cd"
    print_osc4 8 "09/20/27"
    ...
    print_osc_rgb 10 "da/d9/df"
    print_osc_rgb 11 "28/2f/32"
    print_osc_rgb 12 "d3/5f/5a"
    print_osc_rgb 17 "ee/b7/ab"
...
do_linux() {
    ...
    print_linux 3 "#b7aa9a"
    print_linux 4 "#2e78c1"
    print_linux 5 "#c0226e"
    print_linux 6 "#309185"
    print_linux 7 "#dad9df"
    print_linux 8 "#092027"
