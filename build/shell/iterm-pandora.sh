...
foreground="#e1e1e1"         # Foreground (Text)
background="#131d42"         # Background
cursor="#43d58e"                 # Cursor
selection="#2d37ff"           # Selection Background
selection_text="#82dffe" # Selection Text
