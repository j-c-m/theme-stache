...
color00="#1c1810"    # Black (Host)
color01="#e35142"    # Red (Syntax string)
...
color09="#e35142"    # Bright Red (Command error)
...
foreground="#736e55"         # Foreground (Text)
background="#1c1810"         # Background
cursor="#736e55"                 # Cursor
selection="#bab696"           # Selection Background
selection_text="#454969" # Selection Text
