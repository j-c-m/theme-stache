...
do_osc() {
    ...
    print_osc4 2 "aa/99/87"
    print_osc4 3 "77/77/54"
    ...
    print_osc4 10 "aa/99/87"
    print_osc4 11 "77/77/54"
...
do_linux() {
    ...
    print_linux 2 "#aa9987"
    print_linux 3 "#777754"
    ...
    print_linux 10 "#aa9987"
    print_linux 11 "#777754"
