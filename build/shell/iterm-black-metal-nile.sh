...
do_osc() {
    ...
    print_osc4 2 "aa/99/88"
    print_osc4 3 "77/77/55"
    ...
    print_osc4 10 "aa/99/88"
    print_osc4 11 "77/77/55"
...
do_linux() {
    ...
    print_linux 2 "#aa9988"
    print_linux 3 "#777755"
    ...
    print_linux 10 "#aa9988"
    print_linux 11 "#777755"
