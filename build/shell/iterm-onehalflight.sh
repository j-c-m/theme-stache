...
foreground="#373942"         # Foreground (Text)
background="#fafafa"         # Background
cursor="#beceff"                 # Cursor
selection="#beceff"           # Selection Background
selection_text="#373942" # Selection Text
