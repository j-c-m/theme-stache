...
do_osc() {
    ...
    print_osc4 3 "85/cf/ec"
    print_osc4 4 "57/84/99"
    print_osc4 5 "96/36/3c"
    print_osc4 6 "b2/59/1d"
    print_osc4 7 "69/5d/47"
    print_osc4 8 "4f/43/30"
    ...
    print_osc_rgb 10 "69/5d/47"
    print_osc_rgb 11 "19/19/19"
    print_osc_rgb 12 "69/5d/47"
    print_osc_rgb 17 "77/6b/53"
    print_osc_rgb 19 "32/12/00"
}
...
do_linux() {
    ...
    print_linux 3 "#85cfec"
    print_linux 4 "#578499"
    print_linux 5 "#96363c"
    print_linux 6 "#b2591d"
    print_linux 7 "#695d47"
    print_linux 8 "#4f4330"
