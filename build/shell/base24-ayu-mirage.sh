...
do_osc() {
    ...
    print_osc4 10 "87/d9/63"
    print_osc4 11 "ff/cc/66"
    print_osc4 12 "80/b0/ff"
    print_osc4 13 "b6/92/ff"
    print_osc4 14 "5c/cf/e6"
...
do_linux() {
    ...
    print_linux 10 "#87d963"
    print_linux 11 "#ffcc66"
    print_linux 12 "#80b0ff"
    print_linux 13 "#b692ff"
    print_linux 14 "#5ccfe6"
