...
do_osc() {
    ...
    print_osc_rgb 10 "c5/ab/60"
    print_osc_rgb 11 "24/12/00"
    print_osc_rgb 12 "c5/ab/60"
    print_osc_rgb 17 "dd/c1/65"
    print_osc_rgb 19 "00/00/00"
}

do_linux() {
    print_linux 0 "#241200"
    print_linux 1 "#d5252b"
    print_linux 2 "#909b00"
    print_linux 3 "#7cc9ce"
    print_linux 4 "#4698a2"
    print_linux 5 "#8c4231"
    print_linux 6 "#d98112"
    print_linux 7 "#c5ab60"
    print_linux 8 "#957f58"
