...
do_osc() {
    ...
    print_osc4 2 "ec/ed/e3"
    print_osc4 3 "97/4a/45"
    ...
    print_osc4 10 "ec/ed/e3"
    print_osc4 11 "97/4a/45"
...
do_linux() {
    ...
    print_linux 2 "#ecede3"
    print_linux 3 "#974a45"
    ...
    print_linux 10 "#ecede3"
    print_linux 11 "#974a45"
