...
do_osc() {
    ...
    print_osc4 1 "48/6e/6f"
    print_osc4 2 "dd/99/99"
    print_osc4 3 "a0/66/66"
    print_osc4 4 "87/87/87"
    print_osc4 5 "99/99/99"
    print_osc4 6 "aa/aa/aa"
    print_osc4 7 "c1/c1/c1"
    print_osc4 8 "33/33/33"
    print_osc4 9 "48/6e/6f"
    print_osc4 10 "dd/99/99"
    print_osc4 11 "a0/66/66"
...
do_linux() {
    ...
    print_linux 1 "#486e6f"
    print_linux 2 "#dd9999"
    print_linux 3 "#a06666"
    print_linux 4 "#878787"
    print_linux 5 "#999999"
    print_linux 6 "#aaaaaa"
    print_linux 7 "#c1c1c1"
    print_linux 8 "#333333"
    print_linux 9 "#486e6f"
    print_linux 10 "#dd9999"
    print_linux 11 "#a06666"
