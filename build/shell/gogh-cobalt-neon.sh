...
do_osc() {
    ...
    print_osc_rgb 12 "8f/f5/86"
    print_osc_rgb 17 "8f/f5/86"
    print_osc_rgb 19 "14/28/38"
}

do_linux() {
    print_linux 0 "#142631"
    print_linux 1 "#ff2320"
    print_linux 2 "#3ba5ff"
