...
do_osc() {
    ...
    print_osc_rgb 10 "c0/b3/c0"
    print_osc_rgb 11 "0e/10/0a"
    print_osc_rgb 12 "c0/b3/c0"
    print_osc_rgb 17 "e2/d1/e3"
    print_osc_rgb 19 "4d/4d/4d"
}

do_linux() {
    print_linux 0 "#0e100a"
    print_linux 1 "#c70031"
    print_linux 2 "#29cf13"
    print_linux 3 "#97a4f7"
    print_linux 4 "#3449d1"
    print_linux 5 "#8400ff"
    print_linux 6 "#0798ab"
    print_linux 7 "#c0b3c0"
    print_linux 8 "#7c777c"
