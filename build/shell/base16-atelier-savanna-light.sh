...
do_osc() {
    ...
    print_osc4 7 "52/60/57"
    print_osc4 8 "78/87/7d"
    ...
    print_osc4 15 "17/1c/19"

    print_osc_rgb 10 "52/60/57"
    print_osc_rgb 11 "ec/f4/ee"
    print_osc_rgb 12 "52/60/57"
    print_osc_rgb 17 "23/2a/25"
    print_osc_rgb 19 "df/e7/e2"
}

do_linux() {
    print_linux 0 "#ecf4ee"
    ...
    print_linux 7 "#526057"
    print_linux 8 "#78877d"
