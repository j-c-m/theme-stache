...
do_osc() {
    ...
    print_osc4 3 "e6/74/1d"
    print_osc4 4 "0f/49/c6"
    print_osc4 5 "66/59/92"
    print_osc4 6 "6f/a4/97"
    print_osc4 7 "f8/db/c0"
    print_osc4 8 "4e/7b/bf"
    ...
    print_osc_rgb 10 "f8/db/c0"
    print_osc_rgb 11 "1e/1c/44"
    print_osc_rgb 12 "ee/bf/37"
    print_osc_rgb 17 "6f/6a/4e"
    print_osc_rgb 19 "f2/d9/c3"
}
...
do_linux() {
    ...
    print_linux 3 "#e6741d"
    print_linux 4 "#0f49c6"
    print_linux 5 "#665992"
    print_linux 6 "#6fa497"
    print_linux 7 "#f8dbc0"
    print_linux 8 "#4e7bbf"
