...
color00="#1c1f24"    # Black (Host)
color01="#cb4b16"    # Red (Syntax string)
color02="#26a6a6"    # Green (Command)
color03="#bcd42a"    # Yellow (Command second)
color04="#2a6bc5"    # Blue (Path)
color05="#a9a1e1"    # Magenta (Syntax var)
color06="#5699af"    # Cyan (Prompt)
color07="#ede0ce"    # White
color08="#2b2a27"    # Bright Black
color09="#ff5d38"    # Bright Red (Command error)
color10="#98be65"   # Bright Green (Exec)
color11="#e5f871"   # Bright Yellow
color12="#51afef"   # Bright Blue (Folder)
color13="#c678dd"   # Bright Magenta
color14="#46d9ff"   # Bright Cyan
color15="#dfdfdf"   # Bright White

foreground="#ecdfcd"         # Foreground (Text)
background="#2b2a27"         # Background
cursor="#9c9c9d"                 # Cursor
selection="#a60033"           # Selection Background
