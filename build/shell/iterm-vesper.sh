...
color08="#7e7e7e"    # Bright Black
color09="#ff8080"    # Bright Red (Command error)
color10="#99ffe4"   # Bright Green (Exec)
...
cursor="#acb1ab"                 # Cursor
selection="#988049"           # Selection Background
selection_text="#acb1ab" # Selection Text
