...
do_osc() {
    ...
    print_osc4 2 "f8/f7/f2"
    print_osc4 3 "79/24/1f"
    ...
    print_osc4 10 "f8/f7/f2"
    print_osc4 11 "79/24/1f"
...
do_linux() {
    ...
    print_linux 2 "#f8f7f2"
    print_linux 3 "#79241f"
    ...
    print_linux 10 "#f8f7f2"
    print_linux 11 "#79241f"
