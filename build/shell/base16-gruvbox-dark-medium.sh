...
color01="#fb4934"    # Red (Syntax string)
color02="#b8bb26"    # Green (Command)
color03="#fabd2f"    # Yellow (Command second)
color04="#83a598"    # Blue (Path)
color05="#d3869b"    # Magenta (Syntax var)
color06="#8ec07c"    # Cyan (Prompt)
color07="#d5c4a1"    # White
color08="#665c54"    # Bright Black
color09="#fb4934"    # Bright Red (Command error)
color10="#b8bb26"   # Bright Green (Exec)
...
foreground="#d5c4a1"         # Foreground (Text)
background="#282828"         # Background
cursor="#d5c4a1"                 # Cursor
