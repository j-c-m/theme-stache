...
color04="#796af5"    # Blue (Path)
color05="#bb60ea"    # Magenta (Syntax var)
color06="#149bda"    # Cyan (Prompt)
color07="#bcbabe"    # White
color08="#838085"    # Bright Black
color09="#d8137f"    # Bright Red (Command error)
color10="#17ad98"   # Bright Green (Exec)
color11="#dc8a0e"   # Bright Yellow
color12="#796af5"   # Bright Blue (Folder)
color13="#bb60ea"   # Bright Magenta
color14="#149bda"   # Bright Cyan
color15="#f5f4f7"   # Bright White

foreground="#bcbabe"         # Foreground (Text)
background="#2e2a31"         # Background
cursor="#bcbabe"                 # Cursor
selection="#d8d7da"           # Selection Background
selection_text="#272825" # Selection Text
