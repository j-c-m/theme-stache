...
do_osc() {
    ...
    print_osc_rgb 10 "b3/b7/b0"
    print_osc_rgb 11 "2a/21/1c"
    print_osc_rgb 12 "b3/b7/b0"
    print_osc_rgb 17 "d3/d7/cf"
    print_osc_rgb 19 "00/00/00"
}

do_linux() {
    print_linux 0 "#2a211c"
    print_linux 1 "#cc0000"
    print_linux 2 "#1a921c"
    print_linux 3 "#43a8ed"
    print_linux 4 "#0066ff"
    print_linux 5 "#c5656b"
    print_linux 6 "#05989a"
    print_linux 7 "#b3b7b0"
    print_linux 8 "#737772"
