...
do_osc() {
    ...
    print_osc4 2 "a5/aa/a7"
    print_osc4 3 "62/6b/67"
    ...
    print_osc4 10 "a5/aa/a7"
    print_osc4 11 "62/6b/67"
...
do_linux() {
    ...
    print_linux 2 "#a5aaa7"
    print_linux 3 "#626b67"
    ...
    print_linux 10 "#a5aaa7"
    print_linux 11 "#626b67"
