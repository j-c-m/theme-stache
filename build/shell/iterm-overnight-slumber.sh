...
color00="#0a1222"    # Black (Host)
color01="#ffa7c4"    # Red (Syntax string)
color02="#85cc95"    # Green (Command)
color03="#ffcb8b"    # Yellow (Command second)
color04="#8dabe1"    # Blue (Path)
color05="#c792eb"    # Magenta (Syntax var)
color06="#78ccf0"    # Cyan (Prompt)
color07="#ffffff"    # White
color08="#575656"    # Bright Black
color09="#ffa7c4"    # Bright Red (Command error)
color10="#85cc95"   # Bright Green (Exec)
color11="#ffcb8b"   # Bright Yellow
color12="#8dabe1"   # Bright Blue (Folder)
color13="#c792eb"   # Bright Magenta
color14="#ffa7c4"   # Bright Cyan
color15="#ffffff"   # Bright White

foreground="#ced2d6"         # Foreground (Text)
background="#0e1729"         # Background
cursor="#ffa7c4"                 # Cursor
selection="#1f2b41"           # Selection Background
selection_text="#ced2d6" # Selection Text
