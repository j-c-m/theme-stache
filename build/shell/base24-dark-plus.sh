...
do_osc() {
    print_osc4 0 "0e/0e/0e"
    print_osc4 1 "cd/31/31"
    print_osc4 2 "0d/bc/79"
    print_osc4 3 "3b/8e/ea"
    ...
    print_osc_rgb 10 "c5/c5/c5"
    print_osc_rgb 11 "0e/0e/0e"
    print_osc_rgb 12 "c5/c5/c5"
    print_osc_rgb 17 "e5/e5/e5"
    print_osc_rgb 19 "00/00/00"
}

do_linux() {
    print_linux 0 "#0e0e0e"
    print_linux 1 "#cd3131"
    print_linux 2 "#0dbc79"
    print_linux 3 "#3b8eea"
    print_linux 4 "#2472c8"
    print_linux 5 "#bc3fbc"
    print_linux 6 "#11a8cd"
    print_linux 7 "#c5c5c5"
