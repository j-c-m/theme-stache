...
do_osc() {
    ...
    print_osc4 1 "ff/81/88"
    print_osc4 2 "b4/e8/8d"
    print_osc4 3 "f4/d6/9e"
    print_osc4 4 "82/aa/ff"
    print_osc4 5 "e8/c0/ff"
