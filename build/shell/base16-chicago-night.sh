...
color00="#1e2a24"    # Black (Host)
color01="#c60c30"    # Red (Syntax string)
color02="#009b3a"    # Green (Command)
color03="#f9e300"    # Yellow (Command second)
color04="#522398"    # Blue (Path)
color05="#e27ea6"    # Magenta (Syntax var)
color06="#00a1de"    # Cyan (Prompt)
color07="#a7b8af"    # White
color08="#5f7368"    # Bright Black
color09="#c60c30"    # Bright Red (Command error)
color10="#009b3a"   # Bright Green (Exec)
color11="#f9e300"   # Bright Yellow
color12="#522398"   # Bright Blue (Folder)
color13="#e27ea6"   # Bright Magenta
color14="#00a1de"   # Bright Cyan
color15="#dbe3de"   # Bright White

foreground="#a7b8af"         # Foreground (Text)
background="#1e2a24"         # Background
cursor="#a7b8af"                 # Cursor
selection="#c1cdc7"           # Selection Background
selection_text="#3e3238" # Selection Text
