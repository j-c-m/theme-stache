...
color01="#ff2b1d"    # Red (Syntax string)
color02="#56ff3d"    # Green (Command)
color03="#fffe44"    # Yellow (Command second)
color04="#0004ff"    # Blue (Path)
color05="#ff2cff"    # Magenta (Syntax var)
color06="#55ffff"    # Cyan (Prompt)
color07="#fffefe"    # White
color08="#fffe44"    # Bright Black
color09="#fffe44"    # Bright Red (Command error)
color10="#fffe44"   # Bright Green (Exec)
color11="#fefb72"   # Bright Yellow
color12="#fffe44"   # Bright Blue (Folder)
color13="#fffe44"   # Bright Magenta
color14="#fffe44"   # Bright Cyan
color15="#fffe44"   # Bright White

foreground="#f2f2f2"         # Foreground (Text)
background="#000042"         # Background
