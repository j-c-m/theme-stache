...
color01="#ad1805"    # Red (Syntax string)
color02="#355d61"    # Green (Command)
color03="#78492a"    # Yellow (Command second)
color04="#0058a1"    # Blue (Path)
color05="#9c2191"    # Magenta (Syntax var)
color06="#703daa"    # Cyan (Prompt)
color07="#000000"    # White
color08="#8a99a6"    # Bright Black
color09="#ad1805"    # Bright Red (Command error)
color10="#174145"   # Bright Green (Exec)
color11="#78492a"   # Bright Yellow
color12="#003f73"   # Bright Blue (Folder)
color13="#9c2191"   # Bright Magenta
color14="#441ea1"   # Bright Cyan
