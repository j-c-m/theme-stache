...
do_osc() {
    ...
    print_osc4 9 "c4/9e/a0"
    print_osc4 10 "9e/c4/9f"
    print_osc4 11 "c4/c1/9e"
    print_osc4 12 "a3/9e/c4"
    print_osc4 13 "c4/9e/c4"
    print_osc4 14 "9e/c3/c4"
...
do_linux() {
    ...
    print_linux 9 "#c49ea0"
    print_linux 10 "#9ec49f"
    print_linux 11 "#c4c19e"
    print_linux 12 "#a39ec4"
    print_linux 13 "#c49ec4"
    print_linux 14 "#9ec3c4"
