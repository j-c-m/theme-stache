...
do_osc() {
    ...
    print_osc4 2 "9b/8d/7f"
    print_osc4 3 "8c/7f/70"
    ...
    print_osc4 10 "9b/8d/7f"
    print_osc4 11 "8c/7f/70"
...
do_linux() {
    ...
    print_linux 2 "#9b8d7f"
    print_linux 3 "#8c7f70"
    ...
    print_linux 10 "#9b8d7f"
    print_linux 11 "#8c7f70"
