...
do_osc() {
    ...
    print_osc4 2 "9a/8c/7e"
    print_osc4 3 "8b/7e/6f"
    ...
    print_osc4 10 "9a/8c/7e"
    print_osc4 11 "8b/7e/6f"
...
do_linux() {
    ...
    print_linux 2 "#9a8c7e"
    print_linux 3 "#8b7e6f"
    ...
    print_linux 10 "#9a8c7e"
    print_linux 11 "#8b7e6f"
