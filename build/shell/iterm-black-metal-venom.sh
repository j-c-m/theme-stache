...
do_osc() {
    ...
    print_osc4 2 "f7/f6/f1"
    print_osc4 3 "78/24/1f"
    ...
    print_osc4 10 "f7/f6/f1"
    print_osc4 11 "78/24/1f"
...
do_linux() {
    ...
    print_linux 2 "#f7f6f1"
    print_linux 3 "#78241f"
    ...
    print_linux 10 "#f7f6f1"
    print_linux 11 "#78241f"
