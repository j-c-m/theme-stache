...
color01="#f64949"    # Red (Syntax string)
color02="#2ea042"    # Green (Command)
color03="#9d6a03"    # Yellow (Command second)
color04="#0078d4"    # Blue (Path)
color05="#d01272"    # Magenta (Syntax var)
color06="#1cb4d5"    # Cyan (Prompt)
color07="#cccccc"    # White
color08="#5c5c5c"    # Bright Black
color09="#db5352"    # Bright Red (Command error)
