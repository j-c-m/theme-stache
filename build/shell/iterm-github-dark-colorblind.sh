...
color01="#ec8e2c"    # Red (Syntax string)
color02="#58a6ff"    # Green (Command)
...
color09="#fdac54"    # Bright Red (Command error)
color10="#79c0ff"   # Bright Green (Exec)
