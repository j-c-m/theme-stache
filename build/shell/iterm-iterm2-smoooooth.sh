...
color00="#14191e"    # Black (Host)
color01="#b43c29"    # Red (Syntax string)
color02="#00c200"    # Green (Command)
color03="#c7c400"    # Yellow (Command second)
color04="#2743c7"    # Blue (Path)
color05="#bf3fbd"    # Magenta (Syntax var)
color06="#00c5c7"    # Cyan (Prompt)
color07="#c7c7c7"    # White
color08="#676767"    # Bright Black
color09="#dc7974"    # Bright Red (Command error)
color10="#57e690"   # Bright Green (Exec)
color11="#ece100"   # Bright Yellow
color12="#a6aaf1"   # Bright Blue (Folder)
color13="#e07de0"   # Bright Magenta
color14="#5ffdff"   # Bright Cyan
color15="#feffff"   # Bright White

foreground="#dbdbdb"         # Foreground (Text)
background="#14191e"         # Background
cursor="#fefffe"                 # Cursor
selection="#b3d7ff"           # Selection Background
