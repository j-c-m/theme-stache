...
color01="#b12424"    # Red (Syntax string)
color02="#006b4f"    # Green (Command)
color03="#f8a300"    # Yellow (Command second)
color04="#138af2"    # Blue (Path)
color05="#9a1b6e"    # Magenta (Syntax var)
color06="#3eb8bf"    # Cyan (Prompt)
color07="#ffffff"    # White
color08="#000000"    # Bright Black
color09="#b12424"    # Bright Red (Command error)
color10="#006b4f"   # Bright Green (Exec)
color11="#f8a300"   # Bright Yellow
color12="#138af2"   # Bright Blue (Folder)
color13="#9a1b6e"   # Bright Magenta
color14="#3eb8bf"   # Bright Cyan
