...
color00="#757575"    # Black (Host)
color01="#825d4d"    # Red (Syntax string)
color02="#718c61"    # Green (Command)
color03="#ada16d"    # Yellow (Command second)
...
foreground="#d3e7d3"         # Foreground (Text)
background="#243434"         # Background
cursor="#576479"                 # Cursor
selection="#ffffff"           # Selection Background
selection_text="#9e8b13" # Selection Text
