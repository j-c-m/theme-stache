...
color01="#d29393"    # Red (Syntax string)
color02="#b3b393"    # Green (Command)
color03="#cbaa89"    # Yellow (Command second)
color04="#a8a1be"    # Blue (Path)
color05="#b39fb0"    # Magenta (Syntax var)
color06="#c0af8c"    # Cyan (Prompt)
color07="#dadada"    # White
color08="#5b5b5b"    # Bright Black
color09="#c95954"    # Bright Red (Command error)
color10="#828040"   # Bright Green (Exec)
color11="#a6794c"   # Bright Yellow
color12="#5a6599"   # Bright Blue (Folder)
color13="#9c6995"   # Bright Magenta
color14="#74a39e"   # Bright Cyan
color15="#ffffff"   # Bright White

foreground="#dadada"         # Foreground (Text)
background="#1a1a1a"         # Background
cursor="#bfad9e"                 # Cursor
selection="#2d2d2d"           # Selection Background
selection_text="#c0af8c" # Selection Text
