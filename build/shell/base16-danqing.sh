...
do_osc() {
    ...
    print_osc4 7 "e0/f0/ef"
    print_osc4 8 "9d/a8/a3"
    ...
    print_osc4 15 "fc/fe/fd"

    print_osc_rgb 10 "e0/f0/ef"
    print_osc_rgb 11 "2d/30/2f"
    print_osc_rgb 12 "e0/f0/ef"
    print_osc_rgb 17 "ec/f6/f2"
    print_osc_rgb 19 "43/48/46"
}

do_linux() {
    print_linux 0 "#2d302f"
    ...
    print_linux 7 "#e0f0ef"
    print_linux 8 "#9da8a3"
