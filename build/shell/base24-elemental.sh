...
color03="#78d8d8"    # Yellow (Command second)
color04="#497f7d"    # Blue (Path)
color05="#7e4e2e"    # Magenta (Syntax var)
color06="#387f58"    # Cyan (Prompt)
color07="#756f68"    # White
color08="#5f5d50"    # Bright Black
...
foreground="#756f68"         # Foreground (Text)
background="#21211c"         # Background
cursor="#756f68"                 # Cursor
selection="#807974"           # Selection Background
selection_text="#3c3b30" # Selection Text
