...
do_osc() {
    ...
    print_osc4 7 "40/5c/79"
    print_osc4 8 "aa/bc/ce"
    ...
    print_osc4 15 "0b/1c/2c"

    print_osc_rgb 10 "40/5c/79"
    print_osc_rgb 11 "f7/f9/fb"
    print_osc_rgb 12 "40/5c/79"
    print_osc_rgb 17 "22/3b/54"
    print_osc_rgb 19 "e5/eb/f1"
}

do_linux() {
    print_linux 0 "#f7f9fb"
    ...
    print_linux 7 "#405c79"
    print_linux 8 "#aabcce"
