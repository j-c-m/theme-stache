...
do_osc() {
    ...
    print_osc4 3 "15/6f/fe"
    print_osc4 4 "12/5c/cf"
    print_osc4 5 "9f/00/bc"
    print_osc4 6 "32/c2/c0"
    print_osc4 7 "9a/9b/9a"
    print_osc4 8 "6b/6d/6a"
    ...
    print_osc_rgb 10 "9a/9b/9a"
    print_osc_rgb 11 "ff/ff/ff"
    print_osc_rgb 12 "9a/9b/9a"
    print_osc_rgb 17 "b2/b2/b2"
...
do_linux() {
    ...
    print_linux 3 "#156ffe"
    print_linux 4 "#125ccf"
    print_linux 5 "#9f00bc"
    print_linux 6 "#32c2c0"
    print_linux 7 "#9a9b9a"
    print_linux 8 "#6b6d6a"
