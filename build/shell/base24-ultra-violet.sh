...
do_osc() {
    ...
    print_osc4 3 "7f/eb/ff"
    print_osc4 4 "47/df/fb"
    print_osc4 5 "d6/30/ff"
    print_osc4 6 "0e/ff/bb"
    print_osc4 7 "c1/c2/c2"
    print_osc4 8 "81/84/84"
    ...
    print_osc_rgb 10 "c1/c2/c2"
    print_osc_rgb 11 "24/27/28"
    print_osc_rgb 12 "c1/c2/c2"
    print_osc_rgb 17 "e1/e1/e1"
    print_osc_rgb 19 "23/26/28"
}
...
do_linux() {
    ...
    print_linux 3 "#7febff"
    print_linux 4 "#47dffb"
    print_linux 5 "#d630ff"
    print_linux 6 "#0effbb"
    print_linux 7 "#c1c2c2"
    print_linux 8 "#818484"
