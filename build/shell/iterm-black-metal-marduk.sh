...
do_osc() {
    ...
    print_osc4 2 "a5/aa/a6"
    print_osc4 3 "61/6a/66"
    ...
    print_osc4 10 "a5/aa/a6"
    print_osc4 11 "61/6a/66"
...
do_linux() {
    ...
    print_linux 2 "#a5aaa6"
    print_linux 3 "#616a66"
    ...
    print_linux 10 "#a5aaa6"
    print_linux 11 "#616a66"
