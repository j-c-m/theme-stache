...
color00="#362b24"    # Black (Host)
color01="#b00a00"    # Red (Syntax string)
color02="#007232"    # Green (Command)
color03="#8b4b00"    # Yellow (Command second)
color04="#005cb4"    # Blue (Path)
color05="#9a0097"    # Magenta (Syntax var)
color06="#006a78"    # Cyan (Prompt)
color07="#d4c2b6"    # White
color08="#504237"    # Bright Black
color09="#de1100"    # Bright Red (Command error)
color10="#008f40"   # Bright Green (Exec)
color11="#ae6000"   # Bright Yellow
color12="#0073e1"   # Bright Blue (Folder)
color13="#c200bd"   # Bright Magenta
color14="#008697"   # Bright Cyan
color15="#e9e1d9"   # Bright White

foreground="#362b24"         # Foreground (Text)
background="#f1ebe6"         # Background
cursor="#362b24"                 # Cursor
selection="#362b24"           # Selection Background
