...
do_osc() {
    ...
    print_osc_rgb 10 "df/da/b7"
    print_osc_rgb 11 "2a/1e/1d"
    print_osc_rgb 12 "57/3d/25"
    print_osc_rgb 17 "56/3c/27"
    print_osc_rgb 19 "df/da/ba"
}

do_linux() {
    print_linux 0 "#573d25"
    print_linux 1 "#be2d26"
    print_linux 2 "#6ba08a"
    print_linux 3 "#e99c29"
    print_linux 4 "#5a86ac"
    print_linux 5 "#ab80a6"
    print_linux 6 "#74a5ac"
    print_linux 7 "#dfdab7"
    print_linux 8 "#9a6b49"
