...
do_osc() {
    ...
    print_osc4 2 "fb/cb/97"
    print_osc4 3 "e7/8a/53"
    ...
    print_osc4 10 "fb/cb/97"
    print_osc4 11 "e7/8a/53"
...
do_linux() {
    ...
    print_linux 2 "#fbcb97"
    print_linux 3 "#e78a53"
    ...
    print_linux 10 "#fbcb97"
    print_linux 11 "#e78a53"
