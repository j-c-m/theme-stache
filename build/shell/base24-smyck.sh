...
foreground="#969696"         # Foreground (Text)
background="#1b1b1b"         # Background
cursor="#969696"                 # Cursor
selection="#a0a0a0"           # Selection Background
selection_text="#5f5f5f" # Selection Text
