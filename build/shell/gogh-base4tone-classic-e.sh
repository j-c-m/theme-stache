...
color01="#088ea0"    # Red (Syntax string)
color02="#c27905"    # Green (Command)
color03="#e8a02c"    # Yellow (Command second)
color04="#b9cf17"    # Blue (Path)
color05="#5cba21"    # Magenta (Syntax var)
color06="#dc9118"    # Cyan (Prompt)
color07="#edeee8"    # White
color08="#0d0d07"    # Bright Black
color09="#25bcd0"    # Bright Red (Command error)
color10="#eaa83e"   # Bright Green (Exec)
color11="#f3cd91"   # Bright Yellow
color12="#eef6b1"   # Bright Blue (Folder)
color13="#69d425"   # Bright Magenta
color14="#e6f28c"   # Bright Cyan
color15="#f9f9f6"   # Bright White

foreground="#a0a290"         # Foreground (Text)
background="#21211c"         # Background
cursor="#877d6e"                 # Cursor
selection="#edeee8"           # Selection Background
selection_text="#121117" # Selection Text
