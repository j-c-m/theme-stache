...
do_osc() {
    ...
    print_osc_rgb 10 "78/87/7d"
    print_osc_rgb 11 "17/1c/19"
    print_osc_rgb 12 "78/87/7d"
    print_osc_rgb 17 "78/87/7d"
    print_osc_rgb 19 "17/1c/19"
}
...
do_linux() {
    ...
    print_linux 7 "#78877d"
    print_linux 8 "#5f6d64"
    print_linux 9 "#9f713c"
