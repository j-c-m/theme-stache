...
do_osc() {
    ...
    print_osc_rgb 10 "b8/b1/a9"
    print_osc_rgb 11 "05/15/19"
    print_osc_rgb 12 "b8/b1/a9"
    print_osc_rgb 17 "e2/d8/cd"
    print_osc_rgb 19 "33/33/33"
}

do_linux() {
    print_linux 0 "#051519"
    print_linux 1 "#f8818e"
    print_linux 2 "#92d3a2"
    print_linux 3 "#39a7a2"
    print_linux 4 "#8ed0ce"
    print_linux 5 "#5e468c"
    print_linux 6 "#31658c"
    print_linux 7 "#b8b1a9"
    print_linux 8 "#666361"
