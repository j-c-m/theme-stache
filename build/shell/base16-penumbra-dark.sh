...
do_osc() {
    ...
    print_osc4 15 "ff/fd/fb"

    print_osc_rgb 10 "be/be/be"
    print_osc_rgb 11 "24/27/2b"
    print_osc_rgb 12 "be/be/be"
    print_osc_rgb 17 "ff/f7/ed"
    print_osc_rgb 19 "30/33/38"
}

do_linux() {
    print_linux 0 "#24272b"
