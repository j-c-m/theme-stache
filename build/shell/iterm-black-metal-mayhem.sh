...
do_osc() {
    ...
    print_osc4 2 "f2/ec/d4"
    print_osc4 3 "ed/cc/6b"
    ...
    print_osc4 10 "f2/ec/d4"
    print_osc4 11 "ed/cc/6b"
...
do_linux() {
    ...
    print_linux 2 "#f2ecd4"
    print_linux 3 "#edcc6b"
    ...
    print_linux 10 "#f2ecd4"
    print_linux 11 "#edcc6b"
