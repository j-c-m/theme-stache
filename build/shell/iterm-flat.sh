...
do_osc() {
    print_osc4 0 "22/2d/3f"
    print_osc4 1 "a8/23/20"
    print_osc4 2 "32/a5/48"
    print_osc4 3 "e5/8d/11"
    print_osc4 4 "31/67/ac"
    print_osc4 5 "78/1a/a0"
    print_osc4 6 "2c/93/70"
    print_osc4 7 "b0/b6/ba"
    print_osc4 8 "21/2c/3c"
    print_osc4 9 "d4/31/2e"
    print_osc4 10 "2d/94/40"
    ...
    print_osc_rgb 10 "2c/c5/5d"
    print_osc_rgb 11 "00/22/40"
    print_osc_rgb 12 "e5/be/0c"
    print_osc_rgb 17 "79/2b/9c"
    print_osc_rgb 19 "ff/ff/ff"
}

do_linux() {
    print_linux 0 "#222d3f"
    print_linux 1 "#a82320"
    print_linux 2 "#32a548"
    print_linux 3 "#e58d11"
    print_linux 4 "#3167ac"
    print_linux 5 "#781aa0"
    print_linux 6 "#2c9370"
    print_linux 7 "#2cc55d"
    print_linux 8 "#212c3c"
    print_linux 9 "#d4312e"
    print_linux 10 "#2d9440"
