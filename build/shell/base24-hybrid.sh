...
foreground="#8f9190"         # Foreground (Text)
background="#161718"         # Background
cursor="#8f9190"                 # Cursor
selection="#b5b8b6"           # Selection Background
selection_text="#4a4749" # Selection Text
