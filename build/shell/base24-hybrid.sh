...
do_osc() {
    ...
    print_osc_rgb 10 "8f/91/90"
    print_osc_rgb 11 "16/17/18"
    print_osc_rgb 12 "8f/91/90"
    print_osc_rgb 17 "b5/b8/b6"
    print_osc_rgb 19 "2a/2e/33"
}

do_linux() {
    print_linux 0 "#161718"
    print_linux 1 "#b74d50"
    print_linux 2 "#b3be5a"
    print_linux 3 "#4b6b88"
    print_linux 4 "#6d90b0"
    print_linux 5 "#a07eab"
    print_linux 6 "#7fbeb3"
    print_linux 7 "#8f9190"
    print_linux 8 "#434446"
