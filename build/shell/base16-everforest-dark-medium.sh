...
do_osc() {
    ...
    print_osc4 7 "85/92/89"
    print_osc4 8 "47/52/58"
    ...
    print_osc_rgb 10 "85/92/89"
    print_osc_rgb 11 "2d/35/3b"
    print_osc_rgb 12 "85/92/89"
    print_osc_rgb 17 "9d/a9/a0"
    print_osc_rgb 19 "34/3f/44"
}
...
do_linux() {
    ...
    print_linux 7 "#859289"
    print_linux 8 "#475258"
