...
color01="#d03e3e"    # Red (Syntax string)
color02="#31861f"    # Green (Command)
color03="#ad8200"    # Yellow (Command second)
color04="#3173c5"    # Blue (Path)
color05="#9e57c2"    # Magenta (Syntax var)
color06="#00998f"    # Cyan (Prompt)
color07="#444444"    # White
color08="#767676"    # Bright Black
color09="#d03e3e"    # Bright Red (Command error)
color10="#31861f"   # Bright Green (Exec)
color11="#ad8200"   # Bright Yellow
color12="#3173c5"   # Bright Blue (Folder)
color13="#9e57c2"   # Bright Magenta
color14="#00998f"   # Bright Cyan
color15="#222222"   # Bright White
