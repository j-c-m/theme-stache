...
color00="#1d1a1e"    # Black (Host)
color01="#ff5b82"    # Red (Syntax string)
color02="#47d7a0"    # Green (Command)
color03="#e7e562"    # Yellow (Command second)
color04="#5db3ee"    # Blue (Path)
color05="#da6cda"    # Magenta (Syntax var)
color06="#56e8ea"    # Cyan (Prompt)
color07="#ececec"    # White
color08="#1d1a1e"    # Bright Black
color09="#ff5b82"    # Bright Red (Command error)
color10="#47d7a1"   # Bright Green (Exec)
color11="#e8e562"   # Bright Yellow
color12="#5db4ee"   # Bright Blue (Folder)
color13="#da6cda"   # Bright Magenta
color14="#57e9eb"   # Bright Cyan
color15="#ededed"   # Bright White

foreground="#efecec"         # Foreground (Text)
background="#1d1a1e"         # Background
cursor="#c7c7c7"                 # Cursor
selection="#e0925c"           # Selection Background
selection_text="#1d1a1e" # Selection Text
