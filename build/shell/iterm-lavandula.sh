...
do_osc() {
    ...
    print_osc_rgb 12 "8c/91/fa"
    print_osc_rgb 17 "37/32/3c"
    print_osc_rgb 19 "8c/91/fa"
}

do_linux() {
    print_linux 0 "#230045"
