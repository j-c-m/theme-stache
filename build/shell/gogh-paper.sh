...
color01="#cc3e28"    # Red (Syntax string)
color02="#216609"    # Green (Command)
color03="#b58900"    # Yellow (Command second)
color04="#1e6fcc"    # Blue (Path)
color05="#5c21a5"    # Magenta (Syntax var)
color06="#158c86"    # Cyan (Prompt)
color07="#aaaaaa"    # White
color08="#555555"    # Bright Black
color09="#cc3e28"    # Bright Red (Command error)
color10="#216609"   # Bright Green (Exec)
color11="#b58900"   # Bright Yellow
color12="#1e6fcc"   # Bright Blue (Folder)
color13="#5c21a5"   # Bright Magenta
color14="#158c86"   # Bright Cyan
color15="#aaaaaa"   # Bright White

foreground="#000000"         # Foreground (Text)
background="#f2eede"         # Background
cursor="#000000"                 # Cursor
selection="#aaaaaa"           # Selection Background
