...
color01="#d23e08"    # Red (Syntax string)
color02="#54ca74"    # Green (Command)
color03="#fff700"    # Yellow (Command second)
color04="#2ab9ff"    # Blue (Path)
color05="#ff50da"    # Magenta (Syntax var)
color06="#1ef9f5"    # Cyan (Prompt)
color07="#ddd0c4"    # White
color08="#515151"    # Bright Black
color09="#ffb7b7"    # Bright Red (Command error)
color10="#c1ffae"   # Bright Green (Exec)
color11="#fcffb8"   # Bright Yellow
color12="#8efff3"   # Bright Blue (Folder)
color13="#ffa2ed"   # Bright Magenta
color14="#bcffc7"   # Bright Cyan
color15="#ffffff"   # Bright White

foreground="#ffffff"         # Foreground (Text)
background="#141515"         # Background
cursor="#ffc663"                 # Cursor
