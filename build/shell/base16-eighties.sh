...
color07="#d3d0c8"    # White
color08="#747369"    # Bright Black
...
color15="#f2f0ec"   # Bright White

foreground="#d3d0c8"         # Foreground (Text)
background="#2d2d2d"         # Background
cursor="#d3d0c8"                 # Cursor
selection="#e8e6df"           # Selection Background
