...
do_osc() {
    print_osc4 0 "02/20/26"
    print_osc4 1 "b2/30/2d"
    print_osc4 2 "00/a9/41"
    print_osc4 3 "59/81/9c"
    print_osc4 4 "45/9a/86"
    ...
    print_osc_rgb 11 "01/11/16"
    print_osc_rgb 12 "4a/fc/d6"
    print_osc_rgb 17 "41/55/55"
    print_osc_rgb 19 "4d/ff/da"
}

do_linux() {
    print_linux 0 "#022026"
    print_linux 1 "#b2302d"
    print_linux 2 "#00a941"
    print_linux 3 "#59819c"
    print_linux 4 "#459a86"
