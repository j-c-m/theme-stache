...
color01="#d61b15"    # Red (Syntax string)
color02="#59a413"    # Green (Command)
color03="#0855fe"    # Yellow (Command second)
color04="#053a8c"    # Blue (Path)
color05="#e40038"    # Magenta (Syntax var)
color06="#2594e0"    # Cyan (Prompt)
color07="#c5c5c5"    # White
color08="#737373"    # Bright Black
color09="#fb1b18"    # Bright Red (Command error)
color10="#6ac118"   # Bright Green (Exec)
color11="#fdc70e"   # Bright Yellow
color12="#0855fe"   # Bright Blue (Folder)
color13="#fb004f"   # Bright Magenta
color14="#3ea7fc"   # Bright Cyan
color15="#8c00eb"   # Bright White

foreground="#c5c5c5"         # Foreground (Text)
background="#181818"         # Background
cursor="#c5c5c5"                 # Cursor
