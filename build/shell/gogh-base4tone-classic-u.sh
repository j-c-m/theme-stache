...
color00="#201d20"    # Black (Host)
color01="#ce672c"    # Red (Syntax string)
color02="#aa52e0"    # Green (Command)
color03="#c988f2"    # Yellow (Command second)
color04="#eb75dd"    # Blue (Path)
color05="#e96375"    # Magenta (Syntax var)
color06="#ba6cea"    # Cyan (Prompt)
color07="#ede8ed"    # White
color08="#0d070c"    # Bright Black
color09="#e78b55"    # Bright Red (Command error)
color10="#d19af4"   # Bright Green (Exec)
color11="#e0baf7"   # Bright Yellow
color12="#f8c3f2"   # Bright Blue (Folder)
color13="#f17e8e"   # Bright Magenta
color14="#f6b1ee"   # Bright Cyan
color15="#f9f6f8"   # Bright White

foreground="#9e949d"         # Foreground (Text)
background="#201d20"         # Background
cursor="#7c7481"                 # Cursor
selection="#ede8ed"           # Selection Background
selection_text="#121712" # Selection Text
