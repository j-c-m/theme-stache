...
do_osc() {
    ...
    print_osc4 2 "dd/ee/cc"
    print_osc4 3 "99/bb/aa"
    ...
    print_osc4 10 "dd/ee/cc"
    print_osc4 11 "99/bb/aa"
...
do_linux() {
    ...
    print_linux 2 "#ddeecc"
    print_linux 3 "#99bbaa"
    ...
    print_linux 10 "#ddeecc"
    print_linux 11 "#99bbaa"
