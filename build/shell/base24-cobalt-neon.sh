...
foreground="#cc72a6"         # Foreground (Text)
background="#142838"         # Background
cursor="#cc72a6"                 # Cursor
selection="#ba45b1"           # Selection Background
selection_text="#45ba4e" # Selection Text
