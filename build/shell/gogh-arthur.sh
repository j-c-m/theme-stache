...
do_osc() {
    ...
    print_osc_rgb 10 "dd/ee/dd"
    print_osc_rgb 11 "1c/1c/1c"
    print_osc_rgb 12 "dd/ee/dd"
    print_osc_rgb 17 "dd/ee/dd"
    print_osc_rgb 19 "1c/1c/1c"
}

do_linux() {
    print_linux 0 "#3d352a"
    print_linux 1 "#cd5c5c"
    print_linux 2 "#86af80"
    print_linux 3 "#e8ae5b"
    print_linux 4 "#6495ed"
    print_linux 5 "#deb887"
    print_linux 6 "#b0c4de"
    print_linux 7 "#ddeedd"
    print_linux 8 "#554444"
