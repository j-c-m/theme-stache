...
color00="#303446"    # Black (Host)
color01="#e78284"    # Red (Syntax string)
color02="#a6d189"    # Green (Command)
color03="#e5c890"    # Yellow (Command second)
color04="#8caaee"    # Blue (Path)
color05="#ca9ee6"    # Magenta (Syntax var)
color06="#81c8be"    # Cyan (Prompt)
color07="#c6d0f5"    # White
color08="#51576d"    # Bright Black
color09="#ea999c"    # Bright Red (Command error)
color10="#a6d189"   # Bright Green (Exec)
color11="#f2d5cf"   # Bright Yellow
color12="#85c1dc"   # Bright Blue (Folder)
color13="#f4b8e4"   # Bright Magenta
color14="#99d1db"   # Bright Cyan
color15="#babbf1"   # Bright White

foreground="#c6d0f5"         # Foreground (Text)
background="#303446"         # Background
cursor="#c6d0f5"                 # Cursor
selection="#f2d5cf"           # Selection Background
selection_text="#0d2a30" # Selection Text
