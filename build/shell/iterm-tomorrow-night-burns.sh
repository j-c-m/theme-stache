...
color00="#252525"    # Black (Host)
color01="#832e31"    # Red (Syntax string)
color02="#a63b3f"    # Green (Command)
color03="#d2494e"    # Yellow (Command second)
color04="#fc595f"    # Blue (Path)
color05="#df9395"    # Magenta (Syntax var)
color06="#b98486"    # Cyan (Prompt)
color07="#f5f5f5"    # White
color08="#5d6f71"    # Bright Black
color09="#832e31"    # Bright Red (Command error)
color10="#a63c3f"   # Bright Green (Exec)
color11="#d2484d"   # Bright Yellow
color12="#fc595f"   # Bright Blue (Folder)
color13="#df9395"   # Bright Magenta
color14="#b98486"   # Bright Cyan
color15="#f5f5f5"   # Bright White

foreground="#a1b0b8"         # Foreground (Text)
background="#151515"         # Background
cursor="#ff443e"                 # Cursor
selection="#afbec5"           # Selection Background
selection_text="#292c31" # Selection Text
