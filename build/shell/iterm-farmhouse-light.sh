...
color01="#8d0003"    # Red (Syntax string)
color02="#3a7d00"    # Green (Command)
color03="#a95600"    # Yellow (Command second)
color04="#092ccd"    # Blue (Path)
color05="#820046"    # Magenta (Syntax var)
color06="#229256"    # Cyan (Prompt)
...
foreground="#1d2027"         # Foreground (Text)
background="#e8e4e1"         # Background
cursor="#006efe"                 # Cursor
selection="#b3b1aa"           # Selection Background
selection_text="#4d5658" # Selection Text
