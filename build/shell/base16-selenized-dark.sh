...
color00="#103c48"    # Black (Host)
color01="#fa5750"    # Red (Syntax string)
color02="#75b938"    # Green (Command)
color03="#dbb32d"    # Yellow (Command second)
color04="#4695f7"    # Blue (Path)
color05="#af88eb"    # Magenta (Syntax var)
color06="#41c7b9"    # Cyan (Prompt)
color07="#adbcbc"    # White
color08="#72898f"    # Bright Black
color09="#fa5750"    # Bright Red (Command error)
color10="#75b938"   # Bright Green (Exec)
color11="#dbb32d"   # Bright Yellow
color12="#4695f7"   # Bright Blue (Folder)
color13="#af88eb"   # Bright Magenta
color14="#41c7b9"   # Bright Cyan
color15="#cad8d9"   # Bright White

foreground="#adbcbc"         # Foreground (Text)
background="#103c48"         # Background
cursor="#adbcbc"                 # Cursor
selection="#cad8d9"           # Selection Background
selection_text="#352726" # Selection Text
