...
do_osc() {
    ...
    print_osc4 2 "f3/ec/d4"
    print_osc4 3 "ee/cc/6c"
    ...
    print_osc4 10 "f3/ec/d4"
    print_osc4 11 "ee/cc/6c"
...
do_linux() {
    ...
    print_linux 2 "#f3ecd4"
    print_linux 3 "#eecc6c"
    ...
    print_linux 10 "#f3ecd4"
    print_linux 11 "#eecc6c"
