...
do_osc() {
    ...
    print_osc4 2 "d0/df/ee"
    print_osc4 3 "5f/81/a5"
    ...
    print_osc4 10 "d0/df/ee"
    print_osc4 11 "5f/81/a5"
...
do_linux() {
    ...
    print_linux 2 "#d0dfee"
    print_linux 3 "#5f81a5"
    ...
    print_linux 10 "#d0dfee"
    print_linux 11 "#5f81a5"
