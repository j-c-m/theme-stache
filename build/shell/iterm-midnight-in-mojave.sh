...
color01="#ff453a"    # Red (Syntax string)
color02="#32d74b"    # Green (Command)
color03="#ffd60a"    # Yellow (Command second)
color04="#0a84ff"    # Blue (Path)
color05="#bf5af2"    # Magenta (Syntax var)
color06="#5ac8fa"    # Cyan (Prompt)
color07="#ffffff"    # White
color08="#1e1e1e"    # Bright Black
...
cursor="#32d74b"                 # Cursor
selection="#4a504d"           # Selection Background
