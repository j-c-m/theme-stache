...
do_osc() {
    ...
    print_osc4 9 "82/82/57"
    print_osc4 10 "2c/26/20"
    print_osc4 11 "43/3b/32"
    print_osc4 12 "8a/80/75"
    print_osc4 13 "be/b6/ae"
    print_osc4 14 "82/57/57"
    print_osc4 15 "db/d6/d1"

    print_osc_rgb 10 "a3/9a/90"
    print_osc_rgb 11 "16/13/0f"
    print_osc_rgb 12 "a3/9a/90"
    print_osc_rgb 17 "43/3b/32"
    print_osc_rgb 19 "a3/9a/90"
}
...
do_linux() {
    ...
    print_linux 9 "#828257"
    print_linux 10 "#2c2620"
    print_linux 11 "#433b32"
    print_linux 12 "#8a8075"
    print_linux 13 "#beb6ae"
    print_linux 14 "#825757"
