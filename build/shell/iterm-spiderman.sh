...
do_osc() {
    ...
    print_osc_rgb 10 "e2/e2/e2"
    print_osc_rgb 11 "1b/1d/1e"
    print_osc_rgb 12 "2b/3f/ff"
    print_osc_rgb 17 "07/0e/4f"
    print_osc_rgb 19 "ef/27/2d"
}
