...
color00="#211d1c"    # Black (Host)
color01="#8d9f04"    # Red (Syntax string)
color02="#dd40a4"    # Green (Command)
color03="#f17ec7"    # Yellow (Command second)
color04="#eb8275"    # Blue (Path)
color05="#dc9118"    # Magenta (Syntax var)
color06="#e963b8"    # Cyan (Prompt)
color07="#eee8e8"    # White
color08="#0d0807"    # Bright Black
color09="#b9cf17"    # Bright Red (Command error)
color10="#f391cf"   # Bright Green (Exec)
color11="#f6b1dd"   # Bright Yellow
color12="#f8cac3"   # Bright Blue (Folder)
color13="#e8a02c"   # Bright Magenta
color14="#fbbab1"   # Bright Cyan
color15="#f9f6f6"   # Bright White

foreground="#a19391"         # Foreground (Text)
background="#211d1c"         # Background
cursor="#81747c"                 # Cursor
selection="#eee8e8"           # Selection Background
selection_text="#111717" # Selection Text
