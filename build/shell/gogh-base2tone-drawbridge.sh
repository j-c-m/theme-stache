...
color00="#1b1f32"    # Black (Host)
color01="#627af4"    # Red (Syntax string)
color02="#67c9e4"    # Green (Command)
color03="#99e9ff"    # Yellow (Command second)
color04="#7289fd"    # Blue (Path)
color05="#67c9e4"    # Magenta (Syntax var)
color06="#8b9efd"    # Cyan (Prompt)
color07="#9094a7"    # White
color08="#51587b"    # Bright Black
color09="#75d5f0"    # Bright Red (Command error)
color10="#252a41"   # Bright Green (Exec)
color11="#444b6f"   # Bright Yellow
color12="#5e6587"   # Bright Blue (Folder)
color13="#c3cdfe"   # Bright Magenta
color14="#5cbcd6"   # Bright Cyan
color15="#e1e6ff"   # Bright White

foreground="#9094a7"         # Foreground (Text)
background="#1b1f32"         # Background
cursor="#289dbd"                 # Cursor
selection="#9094a7"           # Selection Background
selection_text="#6f6b58" # Selection Text
