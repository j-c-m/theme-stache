...
do_osc() {
    ...
    print_osc4 7 "b8/be/ba"
    print_osc4 8 "66/78/6e"
    ...
    print_osc_rgb 10 "b8/be/ba"
    print_osc_rgb 11 "13/1d/42"
    print_osc_rgb 12 "b8/be/ba"
    print_osc_rgb 17 "e1/e1/e1"
    print_osc_rgb 19 "00/00/00"
}

do_linux() {
    print_linux 0 "#131d42"
    ...
    print_linux 7 "#b8beba"
    print_linux 8 "#66786e"
