...
color01="#cc5555"    # Red (Syntax string)
color02="#55cc55"    # Green (Command)
color03="#5555ff"    # Yellow (Command second)
color04="#5455cb"    # Blue (Path)
color05="#cc55cc"    # Magenta (Syntax var)
color06="#7acaca"    # Cyan (Prompt)
color07="#aeaeae"    # White
...
foreground="#aeaeae"         # Foreground (Text)
background="#000000"         # Background
cursor="#aeaeae"                 # Cursor
