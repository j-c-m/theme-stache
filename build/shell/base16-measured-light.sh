...
color00="#fdf9f5"    # Black (Host)
color01="#ac1f35"    # Red (Syntax string)
color02="#0c680c"    # Green (Command)
color03="#645a00"    # Yellow (Command second)
color04="#0158ad"    # Blue (Path)
color05="#6645c2"    # Magenta (Syntax var)
color06="#01716f"    # Cyan (Prompt)
color07="#292929"    # White
color08="#5a5a5a"    # Bright Black
color09="#ac1f35"    # Bright Red (Command error)
color10="#0c680c"   # Bright Green (Exec)
color11="#645a00"   # Bright Yellow
color12="#0158ad"   # Bright Blue (Folder)
color13="#6645c2"   # Bright Magenta
color14="#01716f"   # Bright Cyan
color15="#000000"   # Bright White

foreground="#292929"         # Foreground (Text)
background="#fdf9f5"         # Background
cursor="#292929"                 # Cursor
selection="#181818"           # Selection Background
selection_text="#e7e7e7" # Selection Text
