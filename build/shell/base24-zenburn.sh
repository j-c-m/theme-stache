...
color03="#94bff3"    # Yellow (Command second)
color04="#506070"    # Blue (Path)
color05="#dc8cc3"    # Magenta (Syntax var)
color06="#8cd0d3"    # Cyan (Prompt)
color07="#c1c9b9"    # White
color08="#8ba393"    # Bright Black
color09="#dca3a3"    # Bright Red (Command error)
color10="#c3bf9f"   # Bright Green (Exec)
color11="#e0cf9f"   # Bright Yellow
color12="#94bff3"   # Bright Blue (Folder)
color13="#ec93d3"   # Bright Magenta
color14="#93e0e3"   # Bright Cyan
color15="#ffffff"   # Bright White

foreground="#c1c9b9"         # Foreground (Text)
background="#3f3f3f"         # Background
cursor="#c1c9b9"                 # Cursor
selection="#dcdccc"           # Selection Background
selection_text="#232333" # Selection Text
