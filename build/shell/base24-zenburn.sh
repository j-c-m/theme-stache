...
do_osc() {
    ...
    print_osc4 3 "94/bf/f3"
    print_osc4 4 "50/60/70"
    print_osc4 5 "dc/8c/c3"
    print_osc4 6 "8c/d0/d3"
    print_osc4 7 "c1/c9/b9"
    print_osc4 8 "8b/a3/93"
    ...
    print_osc_rgb 10 "c1/c9/b9"
    print_osc_rgb 11 "3f/3f/3f"
    print_osc_rgb 12 "c1/c9/b9"
...
do_linux() {
    ...
    print_linux 3 "#94bff3"
    print_linux 4 "#506070"
    print_linux 5 "#dc8cc3"
    print_linux 6 "#8cd0d3"
    print_linux 7 "#c1c9b9"
    print_linux 8 "#8ba393"
