...
do_osc() {
    ...
    print_osc_rgb 10 "99/95/80"
    print_osc_rgb 11 "20/20/1d"
    print_osc_rgb 12 "99/95/80"
    print_osc_rgb 17 "99/95/80"
    print_osc_rgb 19 "20/20/1d"
}
...
do_linux() {
    ...
    print_linux 7 "#999580"
    print_linux 8 "#7d7a68"
    print_linux 9 "#b65611"
