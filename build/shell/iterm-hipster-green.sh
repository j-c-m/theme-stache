...
color01="#b6204a"    # Red (Syntax string)
color02="#00a600"    # Green (Command)
color03="#bebe00"    # Yellow (Command second)
...
foreground="#84c137"         # Foreground (Text)
background="#0f0a05"         # Background
cursor="#23ff18"                 # Cursor
selection="#083905"           # Selection Background
