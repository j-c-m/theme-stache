...
do_osc() {
    ...
    print_osc_rgb 10 "f6/d5/6a"
    print_osc_rgb 11 "11/0b/0d"
    print_osc_rgb 12 "c3/6c/32"
    print_osc_rgb 17 "f6/d5/6a"
    print_osc_rgb 19 "11/0b/0d"
}

do_linux() {
    print_linux 0 "#341a0d"
    print_linux 1 "#9b281b"
    print_linux 2 "#626132"
    print_linux 3 "#c26e27"
    print_linux 4 "#515b5c"
    print_linux 5 "#9b1d29"
    print_linux 6 "#588056"
    print_linux 7 "#f6d56a"
    print_linux 8 "#874227"
