...
color00="#1E2229"    # Black (Host)
color01="#ED1515"    # Red (Syntax string)
color02="#44853A"    # Green (Command)
...
color10="#55A649"   # Bright Green (Exec)
...
selection="#FCFCFC"           # Selection Background
selection_text="#030303" # Selection Text
