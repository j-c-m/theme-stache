...
do_osc() {
    ...
    print_osc4 9 "ff/73/83"
    print_osc4 10 "86/b3/00"
    print_osc4 11 "ff/aa/33"
    print_osc4 12 "47/8a/cc"
    print_osc4 13 "b5/95/d6"
    print_osc4 14 "55/b4/d4"
...
do_linux() {
    ...
    print_linux 9 "#ff7383"
    print_linux 10 "#86b300"
    print_linux 11 "#ffaa33"
    print_linux 12 "#478acc"
    print_linux 13 "#b595d6"
    print_linux 14 "#55b4d4"
