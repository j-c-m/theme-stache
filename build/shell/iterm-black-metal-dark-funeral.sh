...
do_osc() {
    ...
    print_osc4 2 "d0/de/ed"
    print_osc4 3 "5e/81/a5"
    ...
    print_osc4 10 "d0/de/ed"
    print_osc4 11 "5e/81/a5"
...
do_linux() {
    ...
    print_linux 2 "#d0deed"
    print_linux 3 "#5e81a5"
    ...
    print_linux 10 "#d0deed"
    print_linux 11 "#5e81a5"
