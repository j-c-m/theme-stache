...
do_osc() {
    ...
    print_osc4 2 "dd/ed/cc"
    print_osc4 3 "99/ba/aa"
    ...
    print_osc4 10 "dd/ed/cc"
    print_osc4 11 "99/ba/aa"
...
do_linux() {
    ...
    print_linux 2 "#ddedcc"
    print_linux 3 "#99baaa"
    ...
    print_linux 10 "#ddedcc"
    print_linux 11 "#99baaa"
