...
color02="#7e8d50"    # Green (Command)
color03="#e5b567"    # Yellow (Command second)
color04="#6c99ba"    # Blue (Path)
color05="#9e4e85"    # Magenta (Syntax var)
color06="#7dd5cf"    # Cyan (Prompt)
color07="#d0d0d0"    # White
color08="#505050"    # Bright Black
color09="#ac4142"    # Bright Red (Command error)
color10="#7e8d50"   # Bright Green (Exec)
color11="#e5b566"   # Bright Yellow
color12="#6c99bb"   # Bright Blue (Folder)
...
selection_text="#d0d0d0" # Selection Text
