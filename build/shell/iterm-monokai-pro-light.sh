...
do_osc() {
    ...
    print_osc_rgb 11 "fa/f4/f2"
    print_osc_rgb 12 "70/6b/6e"
    print_osc_rgb 17 "bf/b9/ba"
    print_osc_rgb 19 "29/24/2a"
}

do_linux() {
    print_linux 0 "#faf4f2"
