...
do_osc() {
    ...
    print_osc4 3 "69/bf/fa"
    print_osc4 4 "7a/a5/ff"
    print_osc4 5 "be/9b/f8"
    print_osc4 6 "56/d3/c1"
    print_osc4 7 "c3/c3/d4"
    print_osc4 8 "85/85/ac"
    ...
    print_osc_rgb 10 "c3/c3/d4"
    print_osc_rgb 11 "29/2a/44"
    print_osc_rgb 12 "c3/c3/d4"
    print_osc_rgb 17 "e3/e2/e8"
    print_osc_rgb 19 "12/13/1d"
}
...
do_linux() {
    ...
    print_linux 3 "#69bffa"
    print_linux 4 "#7aa5ff"
    print_linux 5 "#be9bf8"
    print_linux 6 "#56d3c1"
    print_linux 7 "#c3c3d4"
    print_linux 8 "#8585ac"
