...
color03="#3daee9"    # Yellow (Command second)
color04="#1d99f3"    # Blue (Path)
color05="#9b59b6"    # Magenta (Syntax var)
color06="#1abc9c"    # Cyan (Prompt)
color07="#d3d7d8"    # White
color08="#9ba5a6"    # Bright Black
...
foreground="#d3d7d8"         # Foreground (Text)
background="#31363b"         # Background
cursor="#d3d7d8"                 # Cursor
selection="#eff0f1"           # Selection Background
selection_text="#100f0e" # Selection Text
