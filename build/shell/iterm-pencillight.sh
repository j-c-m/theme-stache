...
color03="#a89c14"    # Yellow (Command second)
...
foreground="#424242"         # Foreground (Text)
background="#f1f1f1"         # Background
cursor="#20bbfc"                 # Cursor
selection="#b6d6fd"           # Selection Background
selection_text="#424242" # Selection Text
