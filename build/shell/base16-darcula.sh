...
color01="#4eade5"    # Red (Syntax string)
color02="#6a8759"    # Green (Command)
color03="#bbb529"    # Yellow (Command second)
color04="#9876aa"    # Blue (Path)
color05="#cc7832"    # Magenta (Syntax var)
color06="#629755"    # Cyan (Prompt)
color07="#a9b7c6"    # White
color08="#606366"    # Bright Black
color09="#4eade5"    # Bright Red (Command error)
color10="#6a8759"   # Bright Green (Exec)
color11="#bbb529"   # Bright Yellow
color12="#9876aa"   # Bright Blue (Folder)
color13="#cc7832"   # Bright Magenta
color14="#629755"   # Bright Cyan
color15="#ffffff"   # Bright White

foreground="#a9b7c6"         # Foreground (Text)
background="#2b2b2b"         # Background
cursor="#a9b7c6"                 # Cursor
selection="#ffc66d"           # Selection Background
selection_text="#003992" # Selection Text
