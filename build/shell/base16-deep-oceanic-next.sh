...
color09="#d3464d"    # Bright Red (Command error)
color10="#63b784"   # Bright Green (Exec)
color11="#f3b863"   # Bright Yellow
color12="#568ccf"   # Bright Blue (Folder)
color13="#8b66d6"   # Bright Magenta
color14="#4fb7ae"   # Bright Cyan
...
selection_text="#1f1610" # Selection Text
