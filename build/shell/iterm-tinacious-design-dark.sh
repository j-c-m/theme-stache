...
color00="#1d1d26"    # Black (Host)
color01="#ff3399"    # Red (Syntax string)
color02="#00d364"    # Green (Command)
color03="#ffcc66"    # Yellow (Command second)
color04="#00cbff"    # Blue (Path)
color05="#cc66ff"    # Magenta (Syntax var)
color06="#00ceca"    # Cyan (Prompt)
color07="#cbcbf0"    # White
color08="#626566"    # Bright Black
color09="#ff2f92"    # Bright Red (Command error)
color10="#00d364"   # Bright Green (Exec)
color11="#ffd478"   # Bright Yellow
color12="#00cbff"   # Bright Blue (Folder)
color13="#d783ff"   # Bright Magenta
color14="#00d5d4"   # Bright Cyan
color15="#d4d5f3"   # Bright White

foreground="#cbcbf0"         # Foreground (Text)
background="#1d1d26"         # Background
cursor="#cbcbf0"                 # Cursor
selection="#ff3399"           # Selection Background
