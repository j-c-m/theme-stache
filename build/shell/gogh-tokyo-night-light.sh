...
color15="#343b58"   # Bright White

foreground="#565a6e"         # Foreground (Text)
background="#d5d6db"         # Background
cursor="#565a6e"                 # Cursor
selection="#565a6e"           # Selection Background
selection_text="#d5d6db" # Selection Text
