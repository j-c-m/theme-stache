...
do_osc() {
    ...
    print_osc4 2 "66/ff/66"
    print_osc4 3 "ff/ff/66"
    print_osc4 4 "15/f4/ee"
    ...
    print_osc4 11 "ff/ff/66"
    print_osc4 12 "15/f4/ee"
...
do_linux() {
    ...
    print_linux 2 "#66ff66"
    print_linux 3 "#ffff66"
    print_linux 4 "#15f4ee"
    ...
    print_linux 11 "#ffff66"
    print_linux 12 "#15f4ee"
