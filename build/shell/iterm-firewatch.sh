...
color00="#585f6d"    # Black (Host)
color01="#d95360"    # Red (Syntax string)
color02="#5ab977"    # Green (Command)
color03="#dfb563"    # Yellow (Command second)
color04="#4d89c4"    # Blue (Path)
color05="#d55119"    # Magenta (Syntax var)
color06="#44a8b6"    # Cyan (Prompt)
color07="#e6e5ff"    # White
color08="#585f6d"    # Bright Black
color09="#d95360"    # Bright Red (Command error)
color10="#5ab977"   # Bright Green (Exec)
color11="#dfb563"   # Bright Yellow
color12="#4c89c4"   # Bright Blue (Folder)
color13="#d55119"   # Bright Magenta
color14="#44a8b6"   # Bright Cyan
color15="#e6e5ff"   # Bright White

foreground="#9ba2b2"         # Foreground (Text)
background="#1e2027"         # Background
cursor="#f6f6ec"                 # Cursor
selection="#2e353d"           # Selection Background
selection_text="#7c8fa3" # Selection Text
