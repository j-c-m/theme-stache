...
do_osc() {
    ...
    print_osc4 3 "54/85/c0"
    print_osc4 4 "7b/8f/a4"
    print_osc4 5 "a5/77/9e"
    print_osc4 6 "7f/cc/cb"
    print_osc4 7 "9a/9f/a6"
    print_osc4 8 "6c/6d/70"
    ...
    print_osc_rgb 10 "9a/9f/a6"
    print_osc_rgb 11 "21/21/21"
    print_osc_rgb 12 "9a/9f/a6"
    print_osc_rgb 17 "b2/b8/c2"
...
do_linux() {
    ...
    print_linux 3 "#5485c0"
    print_linux 4 "#7b8fa4"
    print_linux 5 "#a5779e"
    print_linux 6 "#7fcccb"
    print_linux 7 "#9a9fa6"
    print_linux 8 "#6c6d70"
