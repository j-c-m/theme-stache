...
foreground="#cbe0e7"         # Foreground (Text)
background="#1e1c31"         # Background
cursor="#fbfcfc"                 # Cursor
selection="#cbe1e7"           # Selection Background
