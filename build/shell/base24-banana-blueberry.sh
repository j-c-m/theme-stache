...
do_osc() {
    ...
    print_osc_rgb 10 "c6/c9/cd"
    print_osc_rgb 11 "19/13/22"
    print_osc_rgb 12 "c6/c9/cd"
    print_osc_rgb 17 "f1/f1/f1"
    print_osc_rgb 19 "16/14/1e"
}

do_linux() {
    print_linux 0 "#191322"
    print_linux 1 "#ff6a7e"
    print_linux 2 "#00bc9b"
    print_linux 3 "#91fff3"
    print_linux 4 "#22e8df"
    print_linux 5 "#dc3969"
    print_linux 6 "#55b6c1"
    print_linux 7 "#c6c9cd"
    print_linux 8 "#727985"
