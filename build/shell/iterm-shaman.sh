...
color03="#5d8aa9"    # Yellow (Command second)
color04="#449985"    # Blue (Path)
color05="#00599c"    # Magenta (Syntax var)
color06="#5c7e19"    # Cyan (Prompt)
color07="#405554"    # White
color08="#374350"    # Bright Black
...
cursor="#49fcd5"                 # Cursor
selection="#415554"           # Selection Background
selection_text="#5af9d6" # Selection Text
