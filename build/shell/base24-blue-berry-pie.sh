...
do_osc() {
    ...
    print_osc_rgb 10 "bb/b2/ad"
    print_osc_rgb 11 "1c/0b/28"
    print_osc_rgb 12 "bb/b2/ad"
    print_osc_rgb 17 "f0/e7/d5"
    print_osc_rgb 19 "0a/4b/61"
}

do_linux() {
    print_linux 0 "#1c0b28"
    print_linux 1 "#99236d"
    print_linux 2 "#5bb0b2"
    print_linux 3 "#38163d"
    print_linux 4 "#90a5bc"
    print_linux 5 "#9d53a7"
    print_linux 6 "#7e82cc"
    print_linux 7 "#bbb2ad"
    print_linux 8 "#534a5e"
