...
do_osc() {
    ...
    print_osc4 3 "80/7d/7c"
    print_osc4 4 "01/a0/e4"
    print_osc4 5 "a1/6a/94"
    print_osc4 6 "b5/e4/f4"
    print_osc4 7 "92/8f/8e"
    print_osc4 8 "6e/6a/68"
    ...
    print_osc_rgb 10 "92/8f/8e"
    print_osc_rgb 11 "09/03/00"
    print_osc_rgb 12 "92/8f/8e"
    print_osc_rgb 17 "a5/a2/a2"
    print_osc_rgb 19 "09/03/00"
}
...
do_linux() {
    ...
    print_linux 3 "#807d7c"
    print_linux 4 "#01a0e4"
    print_linux 5 "#a16a94"
    print_linux 6 "#b5e4f4"
    print_linux 7 "#928f8e"
    print_linux 8 "#6e6a68"
