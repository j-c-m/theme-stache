...
color02="#b9ca49"    # Green (Command)
color03="#e7c547"    # Yellow (Command second)
color04="#79a6da"    # Blue (Path)
color05="#c397d8"    # Magenta (Syntax var)
color06="#70c0b1"    # Cyan (Prompt)
color07="#fffefe"    # White
color08="#000000"    # Bright Black
color09="#d44d53"    # Bright Red (Command error)
color10="#b9c949"   # Bright Green (Exec)
color11="#e6c446"   # Bright Yellow
color12="#79a6da"   # Bright Blue (Folder)
color13="#c396d7"   # Bright Magenta
...
selection_text="#e9e9e9" # Selection Text
